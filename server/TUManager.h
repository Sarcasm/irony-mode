...
public:
  ...
  /**
   * \brief Register some \c Settings for this particular TUManager
   *        instance.
   *
   * \param settings
   *
   * \return An object representing this registration, aims to be use
   *         by \c unregisterSettings() when the settings are no
   *         longer required.
   *
  ...
  /**
   * \brief Unregister the given settings generated by a previous call
   *        to \c registerSettings().
   *
...
private:
  /**
   * \brief Recalculate the settings and invalidate cached translation
   *        units.
   */
