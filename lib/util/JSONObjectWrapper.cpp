/**
 * \file   JSONObjectWrapper.cpp
 * \author Guillaume Papin <guillaume.papin@epitech.eu>
 * \date   Wed Aug 24 16:25:28 2011
 *
...
bool JSONObjectWrapper::good() const { return isObject_; }
JSONObjectWrapper::operator bool() const { return isObject_; }
...
JSONObjectWrapper::Checker::operator std::vector<std::string>() const
{
  ...
  for (JSONArray::const_iterator it = ary.begin(), end = ary.end();
       it != end; ++it)
    {
      if (! (*it)->IsString())
        {
